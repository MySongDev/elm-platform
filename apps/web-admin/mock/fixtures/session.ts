...
import type { UserInfo, UserMenuNode } from '../../src/entities/session/model/types'
...
// 与后端 apps/server/src/modules/admin/constants/admin-fallback-data.ts 中的 fallbackMenus 对齐
// 注意：catalog/button 类型不携带 component；menu 类型必须给出组件 key（对应 /src/pages/{key}/index.vue）
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        // 后端约定该菜单无实体页面组件，仅承载按钮权限，保持 null
        component: null,
        type: 'menu',
        sort: 4,
        status: 1,
